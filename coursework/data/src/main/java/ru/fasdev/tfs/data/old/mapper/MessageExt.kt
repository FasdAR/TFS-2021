...
import ru.fasdev.tfs.data.old.source.network.chat.model.Message
import ru.fasdev.tfs.data.old.source.network.chat.model.Reaction
import ru.fasdev.tfs.data.old.source.network.users.model.user.BaseUser

typealias DomainMessage = ru.fasdev.tfs.domain.old.message.model.Message
typealias DomainReaction = ru.fasdev.tfs.domain.old.message.model.Reaction
